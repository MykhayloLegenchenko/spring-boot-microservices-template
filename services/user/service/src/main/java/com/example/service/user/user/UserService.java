...
import static com.example.client.user.user.dto.UserEvent.TOPIC;
import static com.example.client.user.user.dto.UserEvent.Type.*;
import static com.example.service.user.user.UserRepository.Spec.*;
...
import com.example.service.user.user.model.UserEntity_;
